...
import org.example.tp3.exo3.ProductService;
...
public class ProductServiceTest {
    ...
    public void testGetProductSuccess() throws Exception {
        // Création du mock
        org.example.tp3.exo3.ProductApiClient apiClientMock = mock(org.example.tp3.exo3.ProductApiClient.class);
        org.example.tp3.exo3.ProductService productService = new org.example.tp3.exo3.ProductService(apiClientMock);

        // Préparer une réponse simulée
        org.example.tp3.exo3.Product fakeProduct = new org.example.tp3.exo3.Product("123", "Laptop", 999.99);
    ...
    public void testGetProductApiFailure() throws Exception {
        // Création du mock
        org.example.tp3.exo3.ProductApiClient apiClientMock = mock(ProductApiClient.class);
        org.example.tp3.exo3.ProductService productService = new ProductService(apiClientMock);
